...
static inline add_int_to_fixed_point(int n, int x)
{
  return x + n * F;
}

static inline sub_int_from_fixed_point(int x, int n)
{
  return x - n * F;
}

static inline mult_fixed_point(int x, int y) 
{
  return ((int64_t) x) * y / F;
}

static inline div_fixed_point(int x, int y)
{
